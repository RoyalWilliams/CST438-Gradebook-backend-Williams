...
@SpringBootTest
public class E2E_AddNewAssignment {
   ...
   public void addCourseTest() throws Exception {
      ...
      // Puts an Implicit wait for 5 seconds before throwing exception
      ...
      try {       
         ...
         assertNotNull(a, "The assignment is not on need grading list.");
      } catch (Exception ex) {
         throw ex;
      } finally {
         // clean up database.
